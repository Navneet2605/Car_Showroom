...
// here create a new interface to use the props 
    ...
    >
       <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh]  overflow-y-auto transform rounded-2xl bg-white p-6 text-left
            ...
            <div className='flex-1 flex flex-col gap-3'>
                <div className='realative  w-full h-40 bg-pattern bg-cover bg-centre rounded-lg'>
                ...
                <div className='flex-1 flex flex-col gap-2'>
                        ...
                        <div className='mt-3 flex flex-wrap gap-4'>
                                {Object.entries(car).map(([key, vlaue]) => (
                                    <div className='flex justify-between gap-5 w-full text-right' key={key}>
                                        <h4 className='text-grey capitalize'>{key.split("_").join(" ")}</h4>
                                        <p className='text-black-100 font-semibold'>{vlaue}</p>
